...
export const Features = () => {
	return (
		<div className="relative my-10 overflow-y-auto lg:min-h-[70vh] border">
						...
						{/* <div className="lg:pr-4">
							<div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
								<p>
									...
									praesent donec est. Odio penatibus risus viverra tellus varius sit neque erat velit. Faucibus commodo massa rhoncus, volutpat.
						...
						<div className="relative flex flex-col px-2 pt-24 pb-12 font-sans text-gray-300  min-h-[100vh]">
							<div className="flex-1 space-y-8">
								...
								>
									...
									<p className="">
										Lorem ipsum dolor sit, amet consectetur adipisicing elit. Harum, perspiciatis blanditiis accusamus commodi consectetur id tempora
										rem iure eligendi quos eos et autem ratione exercitationem earum laborum ad a sequi!
									</p>
								</div>
								<div
